...
settings_list = [
    ...
    ['Library Services', [
        ...
        setting('Library update services', [''], content.classes.refresh, 'active', entry="library update service", subclass=True,
                radio=False, required=True, preflight=True,
                help='Please choose at least one library update service that plex debrid should update after a complete download'),
        setting('Library ignore services', [''], content.classes.ignore, 'active', entry="library ignore service", subclass=True,
                radio=False, required=True, preflight=True,
                help='Please choose at least one library ignore service that plex debrid should use to ignore content that could repeatedly not be found.'),
    ...
    ['UI Settings', [
        ...
        setting('Auto run repair broken media after cleanup', 'Please enter "true" or "false": ', ui_settings, 'auto_repair_broken_media_after_cleanup', hidden=True,
